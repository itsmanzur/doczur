...
final class Glossary_Taxonomy implements Service {
	...
	public function register_taxonomy() {
		register_taxonomy(
			...
			array(
				'labels'            => array(
					'name'          => _x( 'Glossary Terms', 'taxonomy general name', 'doczur' ),
					'singular_name' => _x( 'Glossary Term', 'taxonomy singular name', 'doczur' ),
					'search_items'  => __( 'Search Glossary Terms', 'doczur' ),
					'all_items'     => __( 'All Glossary Terms', 'doczur' ),
					'edit_item'     => __( 'Edit Glossary Term', 'doczur' ),
					'update_item'   => __( 'Update Glossary Term', 'doczur' ),
					'add_new_item'  => __( 'Add New Glossary Term', 'doczur' ),
					'new_item_name' => __( 'New Glossary Term', 'doczur' ),
					'menu_name'     => __( 'Glossary', 'doczur' ),
				),
				'public'            => false,
				'show_ui'           => true,
